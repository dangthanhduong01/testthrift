...
var _ = trythrift.GoUnusedProtection__
...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  i32 multiply(i32 num1, i32 num2)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := trythrift.NewCalculatorClient(thrift.NewTStandardClient(iprot, oprot))
